...
### Add notifications for Slack or email

Serverless Framework Enterprise can notify you in **Slack** or **Email** about any [alerts](#alerts) on your application. Multiple notfications can be added to an application and each can be configured for different types and scoped to individual alerts, stages or services.
